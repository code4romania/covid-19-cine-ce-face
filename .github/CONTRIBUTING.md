...
:bug: Think you found a bug? Please check [the list of open issues](https://github.com/code4romania/whos-who/issues) to see if your bug has already been reported. If it hasn't please [submit a new issue](https://github.com/code4romania/whos-who/issues/new).
...
To send us a suggestion, just [open an issue](https://github.com/code4romania/whos-who/issues/new) which describes the feature you would like to see. Give as much information as you can about what you would like to see:
...
* [Good first issues](https://github.com/code4romania/whos-who/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
* [Help wanted](https://github.com/code4romania/whos-who/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22)
